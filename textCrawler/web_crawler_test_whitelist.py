...
def webcrawler():
    # 내부링크를 얻을 사이트의 정보
    siteInfo = [
        'http://www.ocrwebservice.com/', # targetUrl
        'http://www.ocrwebservice.com/',   # rootUrl
        'td',                       # tagName of exist <a> tag
        'tbl_style_block2'                     # className of exist <a> tag
    ]
    ...
    # 타이틀과 내용을 얻을 사이트의 정보
    siteData = [
        ['ocrwebservice', 'http://www.ocrwebservice.com/', 'h1', 'div#header-div']
    ]
